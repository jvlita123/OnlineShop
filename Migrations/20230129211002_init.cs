    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShopAttributeID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopAttributes", x => x.ShopAttributeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdressFlat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    AdressCountry = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableAmmount = table.Column<int>(type: "int", nullable: false),
                    CategoryID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAdressFlat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryAdressBuilding = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryAdressStreet = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryAdressCity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryAdressCountry = table.Column<string>(type: "nvarchar(max)", nullable: false),
