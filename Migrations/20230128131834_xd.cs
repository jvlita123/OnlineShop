        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdressFlat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AdressBuilding = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AdressStreet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AdressCity = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableAmmount = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAdressFlat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAdressBuilding = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAdressStreet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAdressCity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeliveryAdressCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductID = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsProfilePicture = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
